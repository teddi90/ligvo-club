                ...
                <div class="col-md-6">
                    <div class="game game__card">
                        ...
                        <figcaption>
                            ...
                            <p class="game__text">
                                Текст про гру, які є ігри, вікова категорія,
                                жанри, типи і тд. Текст про настільні ігри, які
                                є ігри, вікова категорія, жанри, типи і тд.
                                Текст про настільні ігри, які є ігри, вікова
                                категорія, жанри, типи і тд. Текст про настільні
                                ігри, які є ігри, вікова категорія, жанри, типи
                                і тд. Текст про настільні ігри, які є ігри,
                                вікова категорія, жанри, типи і тд.
                            </p>
                ...
                <div class="col-md-6">
                    <div class="game game__card">
                        <figure>
                            <div class="game__img_wrapper">
                                <img
                                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSyWQXdbIBp3XyDv3ovCHgppdyBU-Do4el6RA&usqp=CAU"
                                    alt="Board game"
                                    class="game__img"
                                />
                            </div>
                        ...
                        <figcaption>
                            <div class="game__info">
                                <h3 class="game__title">Манчкін</h3>
                                <div>
                                    <div class="game__info_item">
                                        <svg
                                            width="14"
